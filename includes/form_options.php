...
<!-- Detect -->
		...
		<blockquote>
		    ...
		    <br /><br />
            <label>
              <input type="radio" id="redirect" name="redirect" value="others" <?php echo ((get_option('cml_option_redirect', 'auto') == 'others') ? 'checked' : '') ?> />
		      <?php _e('Redirect only if user language is different from default one', 'ceceppaml'); ?>
            </label>
		    <br /><br />
		    <label>
